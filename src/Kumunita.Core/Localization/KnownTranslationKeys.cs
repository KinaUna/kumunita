...
public static class KnownTranslationKeys
{
    ...
    public static IReadOnlyDictionary<string, string> EnValues { get; } =
        new Dictionary<string, string>
        {
            ...
            ["pl.project.status_hint"] = "An optional state label — the project's vocabulary is whatever you name it. Leave blank for none.",
    ...
    public static IReadOnlyDictionary<string, string> DeValues { get; } =
        new Dictionary<string, string>
        {
            ...
            ["pl.project.status"] = "Status",
            ["pl.project.status_hint"] = "Ein optionales Zustandslabel — der Projektwortschatz ist, was du daraus machst. Leer lassen für keinen.",
            ["pl.project.start_date"] = "Start",
    ...
    public static IReadOnlyDictionary<string, string> FrValues { get; } =
        new Dictionary<string, string>
        {
            ...
            ["pl.project.status_hint"] = "Un libellé d'état optionnel — le vocabulaire du projet est ce que tu en fais. Laisse vide pour aucun.",
    ...
    public static IReadOnlyDictionary<string, string> DaValues { get; } =
        new Dictionary<string, string>
        {
            ...
            ["pl.project.status"] = "Status",
            ["pl.project.status_hint"] = "Et valgfrit statuslabel — projektets ordforråd er, hvad du gør ud af det. Lad være tom for ingen.",
            ["pl.project.start_date"] = "Start",
