...
`docs/plans-milestones/m1-step-7-handoff-notes.md` for the as-built record, `run_build`
...
`docs/plans-milestones/plan-m1-step-7-outbox-email-c3.md` (lines 115–121) — this file
...
- `docs/plans-milestones/m1-step-7-handoff-notes.md` — the `## U1 — pinned API` section
...
- Handoff-note section `## U2 — stager reworked` appended to
  `docs/plans-milestones/m1-step-7-handoff-notes.md` *before* unit exit — ✅ (the two file
