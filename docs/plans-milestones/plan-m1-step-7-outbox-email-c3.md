...
- `docs/plans-milestones/m1-step-7-handoff-notes.md` (new) — the rolling handoff log, one section per unit.
...
- **Scratch — `docs/plans-milestones/m1-step-7-handoff-notes.md`** — one appended section per unit (never rewritten), written **before** the unit exits.
...
6. `docs/plans-milestones/m1-step-7-handoff-notes.md` contains exactly one section per completed unit (U1–U5, plus U6 if run), in order, each appended (never rewritten).
