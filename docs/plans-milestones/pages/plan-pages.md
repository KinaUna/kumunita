...
| U04 | `PageController` + tree + post view + composer (WYSIWYG) | Web tests green, E2E browse/compose | ☐ |
| U05 | reference-from-UGC + seeded pages + `/about` fallback | fresh instance byte-identical, link gated | ☐ |
