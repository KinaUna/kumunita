...
**Status: complete (all steps executed; see the `## U3 — call sites verified/reordered` section in `docs/plans-milestones/done/m1-step-7-handoff-notes.md` for the as-built record, the per-call-site invariant evidence, the canary-run result, and the files-touched table).** This file is the unit's own execution plan, saved per the unit brief; the authoritative sealed-unit contract is still `docs/plans-milestones/done/plan-m1-step-7-outbox-email-c3.md` (lines 123–127) — this file mirrors it and does not supersede it.
...
- `docs/plans-milestones/done/m1-step-7-handoff-notes.md` — the `## U1 — pinned API` and
...
1. `docs/plans-milestones/done/m1-step7-u3-plan.md` (this file) — the unit's own plan +
   decision log.
2. `docs/plans-milestones/done/m1-step-7-handoff-notes.md` — the `## U3 — call sites
