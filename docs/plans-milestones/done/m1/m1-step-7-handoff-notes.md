...
| `docs/plans-milestones/done/m1-step7-u3-plan.md` | (new) The unit's own execution plan + decision log. |
| `docs/plans-milestones/done/m1-step-7-handoff-notes.md` | Appended this U3 section. |
...
| `docs/plans-milestones/done/m1-step7-u4-plan.md` | (new) This unit's own plan file, as instructed by the unit task text ("Create a plan for the U4 work and save it to …"). |
| `docs/plans-milestones/done/m1-step-7-handoff-notes.md` | Appended this `## U4 — boot order fixed` section (before unit exit, per the unit-series rule). |
...
| `docs/plans-milestones/done/m1-step7-u5-plan.md` | (new) This unit's own plan file. |
| `docs/plans-milestones/done/m1-step-7-handoff-notes.md` | Appended this `## U5 — verified + comments reconciled` section. |
...
- `docs/plans-milestones/done/m1-step7-u6-plan.md` — this unit's plan + full evidence
