...
Steps 1–3 of M1 are complete (per `docs/plans-milestones/done/plan-m1-identity-groups-delegation-authorization.md`):
...
- **new** `docs/plans-milestones/done/plan-m1-step-4-userinfomodule.md` — this plan document, saved at the outset for the record (user request; matches the existing milestone-plan naming in that folder).
...
- Update `docs/plans-milestones/done/plan-m1-identity-groups-delegation-authorization.md` step-4 line (checkmark / status) once green.
...
1. **Save the plan document** — create `docs/plans-milestones/done/plan-m1-step-4-userinfomodule.md` containing this plan verbatim (title, context, approach, sketches, tests, acceptance, risks, steps) — user-requested record; matches the folder's existing `plan-m1-*` naming.
...
update the status of step 4 in `docs/plans-milestones/done/plan-m1-identity-groups-delegation-authorization.md` (checkmark / "complete — 11/11 handler tests green");
