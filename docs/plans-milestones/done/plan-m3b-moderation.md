...
`docs/plans-milestones/done/m3-handoff-notes.md` § `## Summary`, gate 142/142, 0
...
- **Rolling handoff note:** `docs/plans-milestones/done/m3b-handoff-notes.md` (new
...
- **Secondary — this file** (`docs/plans-milestones/done/plan-m3b-moderation.md`)
  — the unit registry with each unit's deliverables and exit criteria.
- **Scratch — the rolling handoff note**
  (`docs/plans-milestones/done/m3b-handoff-notes.md`). One section per unit,
...
- **Entry reads:** `docs/design/m3-posts-design.md` §§ Scope / Invariants /
  ...
  source of truth), `docs/plans-milestones/done/m3-handoff-notes.md` § `## Summary`
...
- **Entry reads:** all three tiers — `docs/design/m3b-moderation.md` (full),
  `docs/plans-milestones/done/plan-m3b-moderation.md` (this file, full),
  `docs/plans-milestones/done/m3b-handoff-notes.md` (all U1–U10 sections).
- **Deliverables (2 files, modify):** `docs/design/m3b-moderation.md` —
  ...
  `docs/plans-milestones/done/m3b-handoff-notes.md` — append `## Summary` (a
...
*M3b opens with `docs/plans-milestones/done/m3-handoff-notes.md` § `## Summary`
