...
- **Entry-reads confirmed:**
  ...
  - `docs/plans-milestones/done/m3-handoff-notes.md` § `## Summary` (the same
...
- **Entry-reads confirmed:**
  ...
  - `docs/design/m3-posts-design.md` § `## Seams & contracts (Part 2)`
    ...
    numbering.
  - `docs/plans-milestones/done/m3-handoff-notes.md` § `## U2 — Design
...
**Unit plan:** `docs/plans-milestones/done/m3b-u3-plan.md` (new file, U3's
...
- `docs/plans-milestones/done/m3b-u5-plan.md` (new — the execution plan).
- `docs/plans-milestones/done/m3b-handoff-notes.md` (this section
  appended).
...
- **Files touched**
  ...
  - `docs/plans-milestones/done/m3b-u6-plan.md` (new — the execution plan).
  - `docs/plans-milestones/done/m3b-handoff-notes.md` (this section appended).
- **Build / test state**
...
- **Back-fill note (for the record):** this section was authored during the
  ...
  (`docs/plans-milestones/done/m3b-u7-plan.md`) and all five U7 Web files
...
- **Files touched**
  ...
  - `src/Kumunita.Web/Views/Posts/Detail.cshtml` (modified — added the
    ...
    unchanged).
  - `docs/plans-milestones/done/m3b-u8-plan.md` (new — the execution plan).
  - `docs/plans-milestones/done/m3b-handoff-notes.md` (this section appended).
- **Build / test state**
...
- **Note (resolved — U7 back-filled):** when U8 began, the handoff notes
  ...
  - **Files touched**
    ...
    - `docs/plans-milestones/done/m3b-u9-plan.md` (new — the execution plan).
    - `docs/plans-milestones/done/m3b-handoff-notes.md` (this section appended).
  - **Build / test state**
  ...
  - **Entry-reads confirmed:**
    ...
    - `docs/plans-milestones/done/m3-handoff-notes.md` § `## U10 — gate
    ...
    - `docs/plans-milestones/done/m2-handoff-notes.md` lines 239–250 (U13
  ...
  - **Deliverables (three files, in order — per the sealed register
    ...
    1. **`docs/plans-milestones/done/m3b-u11-plan.md` — NEW.** This unit's
    ...
    4. **`docs/plans-milestones/done/m3b-handoff-notes.md` — this section
  ...
  - **Files touched (three, exactly the sealed register § U11
    ...
    - `docs/plans-milestones/done/m3b-u11-plan.md` (new)
