...
- **Unit register line:** `docs/plans-milestones/done/plan-m3b-moderation.md` → U4.
...
- **Exit:** `run_build` green on `Kumunita.Core`; handoff note appended to
  `docs/plans-milestones/done/m3b-handoff-notes.md` as `## U4 — Report filing` **before** any follow-up action.
...
3. **Append** the handoff note section `## U4 — Report filing (U4)
   ...
   `docs/plans-milestones/done/m3b-handoff-notes.md`, mirroring the M2/M3
