...
8. Append the U11 handoff section to `docs/plans-milestones/done/m2-handoff-notes.md` (lists `UpsertProfileAsync` call + `ProfileEditViewModel` fields + the two partial names + deviations).
...
- docs/plans-milestones/done/m2-handoff-notes.md (append)
