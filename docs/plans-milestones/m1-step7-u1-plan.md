...
- `docs/plans-milestones/m1-step-7-handoff-notes.md` — the `## U1 — pinned API` section appended, with the exact `IMessageContext` member + signature recorded verbatim. See the handoff note below / in that file for the record.
...
- [x] Handoff-note section `## U1 — pinned API` appended to `docs/plans-milestones/m1-step-7-handoff-notes.md` before unit exit.
